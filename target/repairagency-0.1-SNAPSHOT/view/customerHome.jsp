    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="command?command=userOrderList&currentPage=1&recordsPerPage=5" <fmt:message
                            key="navbar.my.applications" var="myApp"/>> ${myApp}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#services" <fmt:message key="navbar.leave.feedback"
                                                                      var="leaveFeebk"/>> ${leaveFeebk}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#testimonials" <fmt:message key="customer.mydata"
